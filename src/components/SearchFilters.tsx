...
const CATEGORIES = ['shirt', 'pants', 'dress', 'jacket', 'shoes', 'accessories', 'ringar', 'kepsar', 'klockor', 'sweatpants', 'sheer', 'long-sleeve', 'bike-shorts', 'workout-leggings', 'workout-top', 'denim-skirt', 'shoulder-bag', 'hobo-bag', 'hand-bag', 'rain-jacket'];
